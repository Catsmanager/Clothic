...
function OutfitCaptureIllustration() {
  return (
    <View style={styles.captureImageFullBox}>
      <Image source={CAPTURE_IMAGE} style={styles.imageContain} resizeMode="contain" />
    </View>
  )
}
...
const styles = StyleSheet.create({
  ...
  captureImageFullBox: {
    width: contentWidth,
    height: Math.min(ONBOARDING_SCREEN_HEIGHT * 0.52, 480),
    alignItems: 'center',
    justifyContent: 'center',
  },
  memoCard: {
